        ...
        mRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!Patterns.EMAIL_ADDRESS.matcher(emaill).matches()) {
                    ...
                    password.setError("El password debe tener más de 6 caracteres");
        ...
        mAuth.createUserWithEmailAndPassword(emaill, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(RegistrationActivity.this, "Usuario Registrado " + user.getEmail(), Toast.LENGTH_LONG).show();
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(RegistrationActivity.this, "Ocurrio un error", Toast.LENGTH_LONG).show();
            }
        });
    }
