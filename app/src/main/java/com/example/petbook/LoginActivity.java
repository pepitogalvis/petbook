...
public class LoginActivity extends AppCompatActivity {
    ...
    private void beginRecovery(String emaill) {
        loadingBar.setMessage("Enviado correo de recuperacion....");
        ...
        mAuth.sendPasswordResetEmail(emaill).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()) {
                    Toast.makeText(LoginActivity.this, "Enviado", Toast.LENGTH_LONG).show();
                } else {
        ...
        mAuth.signInWithEmailAndPassword(emaill, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(LoginActivity.this, "Usuario Registrado " + user.getEmail(), Toast.LENGTH_LONG).show();
                    ...
                    loadingBar.dismiss();
                    Toast.makeText(LoginActivity.this, "Fallo el inicio de sesión", Toast.LENGTH_LONG).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
