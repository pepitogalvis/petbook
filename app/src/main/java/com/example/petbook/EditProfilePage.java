...
public class EditProfilePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editpassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                pd.setMessage("Cambiar Password");
        ...
        profilepic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pd.setMessage("Actualizar Imagen de Perfil");
        ...
        editname.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pd.setMessage("Actualizar nombre");
        ...
        editpass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(newp)){
                    Toast.makeText(EditProfilePage.this,"La New Password cant be empty",Toast.LENGTH_LONG).show();
                    return;
                }
                dialog.dismiss();
                    ...
                    public void onSuccess(Void aVoid) {
                        user.updatePassword(newp)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        pd.dismiss();
                                        Toast.makeText(EditProfilePage.this,"Cambio de contraseña exitoso",Toast.LENGTH_LONG).show();
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        pd.dismiss();
                                        Toast.makeText(EditProfilePage.this,"Falló el cambio de contraseña",Toast.LENGTH_LONG).show();
                                    }
                                });
                    }
                }).addOnFailureListener(new OnFailureListener() {
    ...
    private void showNamephoneupdate(final String key) {
        ...
        editText.setHint("Ingresar el nuevo nombre");
